...
# Institute (v2) and business (v3) packs reuse the shared engine. Until their dedicated features
# ship, they load with generic vocabulary, booking, FAQ and handoff.
INSTITUTE_PACK = Pack(
    type="institute",
    label="Institute",
    ...
    default_roles={
        ...
        "teacher": ["today", "late", "help", "summary"],
        "front_desk": ["today", "enrol", "followup", "summary", "help"],
    },
    starter_templates=[
        {
            ...
            "gap_days": 0,
            "duration_minutes": 10,
            "aliases": ["ptm", "parent teacher meeting"],
        },
        {
